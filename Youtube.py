...
def api_connect():
    api_key = "AIzaSyDzaXOetLPv8iX4YgccihSpV_9XaHrj-Oc"  # Replace with your actual API key
...
st.markdown("""
    ...
    .reportview-container {
        background: #f0f2f6; /* Background color for the main content */
    }
    .sidebar .sidebar-content {
        background: #f0f2f6; /* Background color for the sidebar */
    }
    .css-1d391kg {
        background-color: #f0f2f6; /* Background color for specific sidebar elements */
    }
    ...
    .css-1d391kg .css-1y4p8pa .css-145kmo2 {
...
st.sidebar.markdown("<h2 style='color: #ff6347;'>Home</h2>", unsafe_allow_html=True)
...
if choice == 'Data Harvesting and Warehousing':
    ...
    st.markdown("<h1 style='color: skyblue;'>YouTube Data Harvesting & Warehousing</h1>", unsafe_allow_html=True)

    channel_id = st.text_input("Enter your Channel ID", key='channel_id_input')
    col1, col2 = st.columns([1, 1])
    with col1:
        get_data_button = st.button('Get Channel Data', key='get_channel_data')

    with col2:
        push_data_button = st.button('Push data to MySQL', key='push_data_to_mysql')
